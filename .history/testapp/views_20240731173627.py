...
from .forms import StudentDetailForm, TestForm, WordForm
import random
...
def create_test(request):
    if request.method == 'POST':
        ...
        if form.is_valid() and word_form.is_valid():
            ...
            if words_data:
                ...
                for word_pair in words_list:
                    if word_pair:
                        ...
                        Word.objects.create(test=test, word=word.strip(), meaning=meaning.strip())
