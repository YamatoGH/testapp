...
class Test(models.Model):
    ...
    group = models.ForeignKey(Group, related_name='tests', on_delete=models.CASCADE, default=1)  # 一時的なデフォルト値

class Word(models.Model):
    test = models.ForeignKey(Test, related_name='words', on_delete=models.CASCADE, default=1)  # 一時的なデフォルト値
