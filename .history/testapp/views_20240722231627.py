...
from .forms import TestForm, WordForm, StudentForm, StudentDetailForm
...
def upload_pdf(request, pk):
    ...
    return render(request, 'testapp/upload_pdf.html', {'form': form, 'test': test})
...
def student_list(request):
    ...
    return render(request, 'testapp/student_list.html', {'students': students, 'form': form})
