...
def create_test(request):
    ...
    return render(request, 'your_app/create_test.html', {'form': form, 'word_formset': word_formset})

def test_detail(request, pk):
    test = get_object_or_404(Test, pk=pk)
    words = test.words.all()
    return render(request, 'your_app/test_detail.html', {'test': test, 'words': words})
